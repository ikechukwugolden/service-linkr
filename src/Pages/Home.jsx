...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow px-4 sm:px-6 lg:px-8 py-8 lg:py-16 max-w-7xl mx-auto relative">
        {/* Payment Banner */}
        <div className="mb-8 lg:mb-12">
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-4 lg:p-6 shadow-lg">
        ...
        <div className="text-center mb-16 lg:mb-24 relative">
          <div className="mb-8">
            <span className="inline-block bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 dark:from-blue-600 dark:via-indigo-600 dark:to-purple-600 text-white text-sm font-semibold px-4 py-2 rounded-full mb-4 shadow-lg">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent block mt-2">
              Providers
            </span>
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12 lg:mb-16">
          <Link 
            to="/payment"
            className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:scale-[1.02] group"
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Pay securely online</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">View & manage appointments</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white">Find Pros</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">Browse verified professionals</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Get help & assistance</p>
              </div>
            </div>
          </Link>
        </div>
        ...
        <div className="mb-16 lg:mb-24 relative">
          <div className="text-center mb-8 lg:mb-12">
            <h2 className="text-2xl lg:text-3xl font-bold mb-4 bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
              Popular Services
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {serviceCategories.map((service, index) => (
              <Link 
                to={service.path}
                key={index}
                className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200 dark:border-gray-700 hover:border-transparent hover:scale-[1.02] group cursor-pointer relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-indigo-500/0 to-purple-500/0 group-hover:from-blue-500/5 group-hover:via-indigo-500/5 group-hover:to-purple-500/5 dark:group-hover:from-blue-500/10 dark:group-hover:via-indigo-500/10 dark:group-hover:to-purple-500/10 transition-all duration-500 -z-0" />
                
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4">
                    <div className="p-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-xl group-hover:from-blue-100 group-hover:to-indigo-100 dark:group-hover:from-blue-800/50 dark:group-hover:to-indigo-800/50 transition-all duration-300">
                      <div className="text-2xl">
                        {service.emoji}
                      </div>
                    </div>
                    <span className="text-sm font-medium bg-gradient-to-r from-blue-500 to-indigo-500 dark:from-blue-400 dark:to-indigo-400 text-white px-3 py-1 rounded-full">
                      {service.count}
                    </span>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                    <span className="text-sm bg-gradient-to-r from-blue-500 to-indigo-500 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent font-medium">
                      Find Providers →
                    </span>
                  </div>
                </div>
        ...
        <div className="mb-16 lg:mb-20">
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 rounded-3xl p-8 lg:p-12 relative overflow-hidden">
            <div className="flex flex-col lg:flex-row items-center justify-between">
              ...
              <div className="lg:w-1/2">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 lg:p-8">
                  ...
                  <Link 
                    to="/payment/methods"
                    className="block w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-center py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300"
                  >
        ...
        {/* How It Works */}
        <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl p-6 lg:p-12 mb-16 lg:mb-20 relative overflow-hidden">
          <div className="text-center mb-8 lg:mb-12">
            <h2 className="text-2xl lg:text-3xl font-bold mb-4 bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 dark:from-blue-300 dark:via-indigo-300 dark:to-purple-300 bg-clip-text text-transparent">
              How It Works
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {howItWorks.map((step, index) => (
              <div key={index} className="relative">
                {index < 2 && (
                  <div className="hidden md:block absolute top-12 left-full w-full h-0.5 bg-gradient-to-r from-blue-300 via-indigo-300 to-purple-300 dark:from-blue-700 dark:via-indigo-700 dark:to-purple-700 -translate-x-1/2"></div>
                )}
                <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 lg:p-8 shadow-xl h-full hover:scale-[1.02] transition-all duration-300 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-center mb-4 lg:mb-6">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 rounded-full flex items-center justify-center text-white font-bold text-lg lg:text-xl mr-3 lg:mr-4 shadow-lg">
                      {step.step}
                    </div>
                    <div className="text-2xl">
                      {step.emoji}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">
                ServiceHub
              </h2>
